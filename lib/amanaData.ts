  ...
  "bus_lines": [
    {
      ...
      "incidents": [
        { "id": 1, "type": "Route", "description": "Bus stop closure", "reported_by": "Driver-1A", "reported_time": "2:25 PM", "status": "Canceled", "priority": "Low" }
      ],
    ...
    },
    {
      ...
      "incidents": [
        { "id": 1, "type": "Passenger", "description": "Unruly passenger", "reported_by": "Driver-2A", "reported_time": "3:23 AM", "status": "Reported", "priority": "High" }
      ],
    ...
    },
    {
      ...
      "incidents": [
        { "id": 1, "type": "Passenger", "description": "Wheelchair accessibility request", "reported_by": "Driver-4A", "reported_time": "10:01 AM", "status": "Resolved", "priority": "Critical" },
        { "id": 2, "type": "Mechanical", "description": "Door sensor issue", "reported_by": "Driver-4B", "reported_time": "11:27 PM", "status": "Canceled", "priority": "Low" }
      ],
